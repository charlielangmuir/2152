...
if not input_invalid:
  ...
  @        ..@#% @     @&*#@(         % 
   &   (  @    (   / /   *    @  .   /  
    ...
    combat_strength, m_combat_strength = functions_lab06.adjust_combat_strength(combat_strength, m_combat_strength)
    ...
    while (num_dream_lvls < 0 or num_dream_lvls > 3):
        ...
        if (num_dream_lvls == ""):
            num_dream_lvls = -1
            print("Number of dream levels must be a whole number between 1 and 3")
        else:
    ...
    print("Dream levels: " + str(num_dream_lvls))
