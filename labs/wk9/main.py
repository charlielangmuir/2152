...
try:
    ...
    print("Error in monster attack function, Error class: " + str(te.__class__))
except Exception as e:
    print("Error in monster attack function, Error class: " + str(e.__class__))
...
while m_health_points > 0 and health_points > 0:
    ...
    if not (attack_roll % 2 == 0):
        ...
        try:
            ...
            print("Error in hero attack function, both params needed to be integers, Error class: " + str(ve.__class__))
